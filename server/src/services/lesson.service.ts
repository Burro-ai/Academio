...
1. **Una Analogía Específica**: Crea una analogía relacionable usando sus intereses ({INTERESTS}), con vocabulario apropiado para su nivel ({GRADE_LEVEL})
2. **Una Pregunta de Reflexión**: Una pregunta socrática que invite a la reflexión, conecte el tema con su vida, y ayude con sus habilidades ({SKILLS})
...
[Analogía conectando con su interés, apropiada para su edad]
...
export const lessonService = {
  ...
  async personalizeContent(
    ...
    console.log(`[Lesson] Personalizing with persona: ${persona.name} for age=${profile.age}, grade=${profile.gradeLevel}`);
