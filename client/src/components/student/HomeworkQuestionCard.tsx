      ...
      <div className="p-6 lg:p-8">
        <div className="flex items-start gap-4">
          ...
          <div className={`flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center font-semibold transition-all duration-300 ${
            isAnswered
              ? 'backdrop-blur-md bg-gradient-to-br from-emerald-500/40 to-blue-500/40 border border-emerald-400/50 text-emerald-700'
          ...
          <div className="flex-1 min-w-0">
            ...
            {!value && !disabled && !onAskSidekick && (
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="mt-3 text-xs text-surface-400 flex items-center gap-1.5"
              >
